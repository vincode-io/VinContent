#
#  Be sure to run `pod spec lint VinContent.podspec' to ensure this is a
...
What isn't relavant, advertisements and other junk, is discarded.
  ...
  # Or just: s.author    = "Maurice Parker"
  # s.authors            = { "Maurice Parker" => "mo@vincode.io" }
  # s.social_media_url   = "http://twitter.com/Maurice Parker"
